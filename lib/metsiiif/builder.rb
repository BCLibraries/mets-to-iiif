    ...
    def build_manifest(mets_file)
      ...
      seed = {
          ...
          'metadata' => [
            ...
            {"label": "Preferred Citation", "value": "#{mets_file.mods.creator + ", " unless mets_file.mods.creator.nil?}#{mods_title}, #{mets_file.sequence_label + ', ' unless mets_file.obj_id.include?('brooker')}#{mets_file.mods.owner}, #{mets_file.handle}."}
          ]
      }
